...
SECRET_KEY = "django-insecure-4pr^(%&u3a76o+v_j-#lf8r0cmz@cxlpa#6l&)n%3&accb_b2v"
DEBUG = True
...
WSGI_APPLICATION = "glucoguide.wsgi.application"
...
if DEBUG:
    # These settings are insecure and should be changed in production
